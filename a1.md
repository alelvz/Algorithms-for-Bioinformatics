...
The assembly was run using both **HiFi long reads** and **Hi-C sequencing data**. The resulting files are stored in the directory `../results/hifiasm/`. Among the multiple outputs generated by Hifiasm, the primary file for evaluation is: 'lizard_asm_hic.hic.p_ctg.gfa'
